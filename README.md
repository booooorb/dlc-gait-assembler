...
1. Choose single-side or multi-side input.
2. Add the required coordinate CSV files.
3. Confirm pairing, body-part labels, calibration, direction, and filters.
4. Select an output folder.
5. Generate and review the stick-plot preview.
6. Run the analysis and inspect the tables, figures, and run log.
